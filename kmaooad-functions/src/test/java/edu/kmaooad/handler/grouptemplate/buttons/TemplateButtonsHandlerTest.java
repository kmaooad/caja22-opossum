...
public class TemplateButtonsHandlerTest {
    @InjectMocks
    ...
    public void testIsNotApplicableConversationState(){
        message.setText(GlobalConstants.GROUP_TEMPLATES_BUTTON_LABEL);
        userSession.setConversationState(ConversationState.CONVERSATION_STARTED);
        Assertions.assertFalse(templateButtonsHandler.isApplicable(userRequest));
    }
    ...
    public void testIsApplicable(){
        message.setText(GlobalConstants.GROUP_TEMPLATES_BUTTON_LABEL);
        userSession.setConversationState(ConversationState.WAITING_FOR_MAIN_MENU_ACTION_CHOICE);
        Assertions.assertTrue(templateButtonsHandler.isApplicable(userRequest));
    }
    ...
    public void testHandler(){
        ...
        HandlerResponse handlerResponse = templateButtonsHandler.handle(userRequest);

        Assertions.assertNull(handlerResponse.getResult());
        Assertions.assertTrue(handlerResponse.isSuccess());
        Assertions.assertEquals(userSession.getConversationState(), ConversationState.WAITING_FOR_TEMPLATE_ACTION_CHOICE);
    }
}
