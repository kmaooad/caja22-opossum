...
import edu.kmaooad.handler.impl.template.button.UpdateTemplateButtonHandler;
...
public class UpdateTemplateButtonHandlerTest {

    @InjectMocks
    private UpdateTemplateButtonHandler updateTemplateButtonHandler;
    ...
    public void initTests(){
        ...
        Mockito.when(updateTemplateDialog.startDialog(Mockito.any(UserRequest.class)))
                .thenReturn(new HandlerResponse(null, true));
    }

    @Test
    public void testIsNotApplicableConversationState(){
        message.setText(GroupTemplateConstants.GROUP_TEMPLATE_EDIT_BUTTON_LABEL);
        userSession.setConversationState(ConversationState.CONVERSATION_STARTED);
        Assertions.assertFalse(updateTemplateButtonHandler.isApplicable(userRequest));
    }
    ...
    public void testIsApplicable(){
        ...
        Assertions.assertTrue(updateTemplateButtonHandler.isApplicable(userRequest));
    }

    @Test
    public void testHandler(){
        HandlerResponse handlerResponse = updateTemplateButtonHandler.handle(userRequest);
