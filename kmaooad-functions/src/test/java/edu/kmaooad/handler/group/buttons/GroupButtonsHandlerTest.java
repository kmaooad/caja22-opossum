...
public class GroupButtonsHandlerTest {
    @InjectMocks
    ...
    public void testIsNotApplicableConversationState(){
        ...
        Assertions.assertFalse(groupButtonsHandler.isApplicable(userRequest));
    }
    ...
    public void testIsApplicable(){
        message.setText(GlobalConstants.GROUP_BUTTON_LABEL);
        userSession.setConversationState(ConversationState.WAITING_FOR_MAIN_MENU_ACTION_CHOICE);
        Assertions.assertTrue(groupButtonsHandler.isApplicable(userRequest));
    }
    ...
    public void testHandler(){
        ...
        HandlerResponse handlerResponse = groupButtonsHandler.handle(userRequest);

        Assertions.assertNull(handlerResponse.getResult());
        Assertions.assertTrue(handlerResponse.isSuccess());
        Assertions.assertEquals(userSession.getConversationState(), ConversationState.WAITING_FOR_GROUP_ACTION_CHOICE);
    }
}
