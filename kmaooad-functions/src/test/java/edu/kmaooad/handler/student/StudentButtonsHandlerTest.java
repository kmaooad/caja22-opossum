...
public class StudentButtonsHandlerTest {
    @InjectMocks
    ...
    public void testIsNotApplicableConversationState(){
        message.setText(GlobalConstants.STUDENTS_BUTTON_LABEL);
        userSession.setConversationState(ConversationState.CONVERSATION_STARTED);
        Assertions.assertFalse(studentButtonsHandler.isApplicable(userRequest));
    }
    ...
    public void testIsApplicable(){
        message.setText(GlobalConstants.STUDENTS_BUTTON_LABEL);
        userSession.setConversationState(ConversationState.WAITING_FOR_MAIN_MENU_ACTION_CHOICE);
        Assertions.assertTrue(studentButtonsHandler.isApplicable(userRequest));
    }
    ...
    public void testHandler(){
        ...
        HandlerResponse handlerResponse = studentButtonsHandler.handle(userRequest);

        Assertions.assertNull(handlerResponse.getResult());
        Assertions.assertTrue(handlerResponse.isSuccess());
        Assertions.assertEquals(userSession.getConversationState(), ConversationState.WAITING_FOR_STUDENT_ACTION_CHOICE);
    }
}
